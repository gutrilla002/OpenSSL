...
#========================================================================
# Derived from https://github.com/ARM-software/AArch64cryptolib.
#========================================================================
...
#define CIPHER_IV	16
#define HMAC_KEY	24
#define HMAC_IKEYPAD	32
#define HMAC_OKEYPAD	40
 ...
 * Prototype:
 *
 * void asm_sha1_hmac_aescbc_dec(uint8_t *csrc, uint8_t *cdst,
